            ...
            <div id="colres">
                <div class="disp">';
                    ...
                    if(!empty($status)){
                        ...
                        echo '<h6 class="status">BIDANG BIMAS HINDU</h6>';
                    }
                    if(!empty($alamat)){
                        echo '<span id="alamat">'.$alamat.'</span>';
                    } else {
                        echo '<span id="alamat">Jl. Udayana No.6, Monjok Bar., Kec. Selaparang, Kota Mataram, Nusa Tenggara Bar. 83125';
                    }
                    echo '
                </div>
                ...
                <tr>                    
                     <td id="right"><strong>Tanggal  </strong></td>
                     <td id="left" colspan="2">:</td>
                </tr>
            </table>
