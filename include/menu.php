...
?>
    ...
    <nav class="blue-grey darken-1">
        <div class="nav-wrapper">
            <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">school</i> SMK PARIWISATA</a>
                    ...
                    <div class="logo-side center blue-grey darken-3">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            if (!empty($data['logo'])) {
                                ...
                                echo '<img class="logoside" src="./asset/img/smk.png"/>';
                            }
                            if (!empty($data['nama'])) {
            ...
            <ul class="center hide-on-med-and-down" id="nv">
                <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">school</i> SMK PARIWISATA</a></li>
                <li>
                    <div class="grs">
                        </>
                </li>
